    ...
    <div v-else class="content-wrapper">
      ...
      <div class="company-info">
        ...
        <div class="info-section">
          ...
          <svg fill="none" height="104.19861602783203" viewBox="0 0 627.8624572753906 104.19861602783203" class="sign-svg"
...
<!--              <animate attributeName="stroke-dashoffset" to="0" dur="3s" fill="freeze"/>-->
          ...
          <p>联系方式: contact@weatherapp.com</p>
        </div>
        ...
        <div class="info-section">
          ...
          <a href="https://alvarotrigo.com/fullPage/zh/" style="color: #ff5e45; font-weight: bold; font-size: 24px; border-radius: 4px;transition: all 0.3s ease;">Fullpage.js</a>
        </div>
      </div>
    </div>
  </div>
...
//签名
setInterval(()=>{
  signSvg.value.style.strokeDashoffset = '2750';
  ...
  if (userData) {
    try {
      ...
      // 检查条件：currentSession === 3
      if (user.currentSession === 3) {
        // 触发动画
        signSvg.value.style.transition = 'stroke-dashoffset 3s ease-out';
        signSvg.value.style.strokeDashoffset = '0';
      }else {
        signSvg.value.style.transition = '';
        signSvg.value.style.strokeDashoffset = '2750';
      }
    } catch (e) {
